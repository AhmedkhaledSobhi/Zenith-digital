...
//       <Box sx={{ color: '#fff', backgroundColor: '#010715', padding: 9 }}>
//         {/* Filter Section */}
//         <Box sx={{ display: 'flex', gap: 2, mb: 4 }}>
//           <FormControl fullWidth sx={{ borderColor: '#FFF' }}>
    ...
    <>
      ...
      >
        ...
        <Grid container m="auto" width="99%"sx={{ spacing:{md:6} ,pl:{xs:0}}}>
          {[...Array(9)].map((_, index) => (
            <Grid item xs={12} sm={6} md={4} key={index} sx={{borderRadius: 10,}}>
              <Box
                style={{
                  backgroundColor: 'transparent',
                  color: '#fff',
              ...
              >
                <CardMedia
                  component="img"
                  height="140"
                  image="/image2.png" // Placeholder image URL
                  alt="Article Image"
                />
